...
//         {/* <i class="uil uil-tachometer-fast-alt" id={main.tachometer}/>
//         <span class={main.text}>Thread</span> */}
//     </div>
// </div>
// <div class={main.container}>
//     <div class={main.post2}>
//         <h6 class={main.username}>{post.username}</h6>
//         <p class={main.description}>{post.description}</p>
//     </div>
// </div>
// <div class={main.container2}>
//     <div class={main.post2}>
//         <h6 class={main.cardTitle}>All Comments:</h6>
//         {
//             allComments.length>0?
//             allComments.map((postedComment) => (
//                 <Link class={main.commentLink} to={`/comment/edit/${postedComment._id}`}>
                //     <div class={main.commentContainer} key={postedComment._id}>
                //     <p class={main.comment}><strong>{postedComment.username}</strong>  {postedComment.comment}</p>
                //     {/* {
...
//         }
        // <div>
        //     <form onSubmit={postComment}>
        //         <div class={main.sendComment}> 
        //             <input type="text" class={main.input} value={comment} onChange= { (e) => setComment(e.target.value)} />
        //             <button class={main.button1}>Send</button>
        //         </div>
        //     </form>
        // </div>
//     </div>
